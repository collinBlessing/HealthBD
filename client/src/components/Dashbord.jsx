  ...
  return (
    ...
    <div className=" h-full w-full  ">
     ...
     <div className="h-4/5 w-full flex mb-0 
      ...
      <div className="flex flex-row h-1/3 w-full  p-1 ">
        <div className="w-1/3  h-full rounded-md flex flex-col ml-2">
        <p className="text-bg-black text-xs w-3/4">Up coming appointments-Today</p>
        ...
        <div className=" h-full w-3/4 flex flex-col">
          <div className=" h-1/6 w-full flex justify-between text-xs">"
            <p className="text-black font-semibold flex flex-start">Up coming appointments-Today</p>
        ...
        <div className="h-5/6 w-full flex flex-col  ">
            ...
            <div className="flex flex-row w-1/4 h-20 ml-3 ">
              <img src={ye} alt="" className="h-1/3 w-1/3 rounded-full"/>
            ...
            <div>
              <button className=" h-full w-full p-3 my-1 rounded-xl text-xs flex flex-col justify-center items-center bg-pink-200">Check in</button>
            </div>
    ...
    <div className="h-1/4 w-full mt-1 border border-1 flex flex-row justify-evenly">
     ...
     <div>
      ...
      <div className="bg-blue-200 h-2/5 w-full my-2">
     
        <div  className="border border-1 h-6 w-full flex justify-between">
        <h1 className="text-xs ml-2">Patient Conversation</h1>
          <div className="flex
          flex-row items-center gap-1 mr-3 bg-blue-600 w-20 rounded-xl p-2 text-xs text-black border border-3">
            <FaPlus />
            <p>Create</p>
          </div>
        </div>
        
  <div className="border border-1 h-6 w-full my-1 flex flex-row justify-between items-center gap-4 px-4">

  <div className="flex items-center gap-2">
    <img src={mine} alt="" className="h-10 w-10 rounded-full" />
...
<div className="border border-1 h-6 w-full my-1 flex flex-row justify-between items-center gap-4 px-4">
  ...
  <div className="border border-1 h-6 w-full flex justify-between">
    ...
    <div className="flex flex-row items-center gap-1 mr-3 bg-blue-600 w-20 rounded-xl p-2 text-xs text-black border border-3">
      <FaPlus />
      <p>Create</p>
    </div>
  </div>
  <div className="border border-1 h-6 w-full my-1 flex flex-row justify-evenly gap-2">
